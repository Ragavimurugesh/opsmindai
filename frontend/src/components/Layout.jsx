...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-brand-dark text-slate-100 overflow-hidden">
      {/* Sidebar Navigation */}
      <aside 
        className={`bg-brand-card/30 backdrop-blur-xl border-r border-brand-border flex flex-col transition-all duration-300 ${
